...
Usage:
    python visualize_reconstruction.py                              # Default: reconstructed_images_gpu.bin
    python visualize_reconstruction.py reconstructed_images_cpu.bin # Custom file
...
def main():
    ...
    # Default: auto-detect (GPU version prefers GPU file)
